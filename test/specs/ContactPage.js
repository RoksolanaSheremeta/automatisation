...
describe('Gamblizard For "Contact page"', () => {
   ...
   it('Test 11: Tool in header NAV redirection of drop-down list',  async () => {
    ...
    it('Test 13: Displayed Contact us block',  async () => {
    ...
    it('Test 15: Displayed Verified Casino Bonuses block',  async () => {
    ...
    it('Test 16: Displayed Subscribe block',  async () => {
        const Subscribe = await $('body > section.subscribe');
        await expect(Subscribe).toBeDisplayed();
    });

    // it('Test 17: Check Subscribe block', async  () => {
    ...
    it('Test 18: Footer column BONUSES', async () => {
    ...
    it('Test 19: Footer column COMPANY', async () => {
    ...
    it('Test 20: Footer bottom links', async () => {
